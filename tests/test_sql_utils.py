...
@fixture
def r1():
    return mk_time_params(ho_win=ho_win1, model_win=mod_win1, ho_start="2018-08-01")


@fixture
def r2():
    return mk_time_params(ho_win=ho_win2, model_win=mod_win2, ho_start="2001-11-01")


def check_model_range(model_start_date=None, ho_start_date=None, model_win=None):
    """
...
def test_ho_range(r1, r2):
    ...
    raises(AssertionError, check_ho_range, r2.ho_start_date, r2.ho_last_date, ho_win1)
